...
public class EntradaBlogAJE {
	 ...
	 */
	public EntradaBlogAJE(int id,String autor,String texto)throws IllegalArgumentException{
	...
	public static void main(String[] args) {
                //Modificar.
		EntradaBlogAJE e1=new EntradaBlogAJE (3,"ana","Últimas noticias, está disponible BixBy 2.0");
